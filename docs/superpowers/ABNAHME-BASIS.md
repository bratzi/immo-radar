...
| D-5 | Das Meldebudget ist nicht dauerhaft ausgeschöpft | **gemessen, weiter offen** — erste Hälfte des Kriteriums erfüllt: Zurückgestellte sanken von 71 (`34630574787`, 17:57–18:20 UTC) auf 47 (`34637349206`, 19:00–20:00 UTC), beide bei 25 von 25 gesendet. Zweite Hälfte bei der ursprünglichen Messung (zwei Läufe, 2026-09-11) NICHT erfüllt: 25/25 `geschaetzt_bundesland`, keine einzige `angegeben`/`geschaetzt_regional` — es gab an diesen zwei Läufen strukturell keine besser belegten Kandidaten (Immowelt allein, keine PLZ in der Ergebnisliste). **Nachgemessen 2026-09-18 über alle 1.184 Meldungen seit 2026-09-11** (Keyset-Blätterung gegen `notifications`, geblockte `.in()`-Abfragen wegen A14): 1.172 Immowelt, **12 zvg-portal** — ZVG hat inzwischen also Plätze bekommen. Von den 1.101 gemeldeten Objekten tragen **12 heute `geschaetzt_regional`** (0 `angegeben` — weiterhin kein einziges Objekt im Bestand mit belegter Miete), und **6 von 981 `pruefkandidat`-Meldungen** entfallen auf Objekte mit dieser besseren Quelle. Die zweite Hälfte ist damit **nicht mehr rein hypothetisch, aber weiterhin eine kleine Minderheit** (6 von 981) — ob das der Reihenfolge-Logik zuzuschreiben ist oder nur daran liegt, dass ZVG über zehn Tage automatisch mal zum Zug kam, ist mit dieser Messung nicht unterschieden |
